      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-3  col-md-6 col-sm-6">
            <div className="single-footer-widget">
              <h6>About</h6>
              <p>
                Hotel reservation and payment tracking system is a project set
                on the purpose of reducing the amount of stress and time it take
                an individual to reserve a room in a hotel. And also to provide
                a simpler means of tracking payment of rooms.
              </p>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-sm-6">
                ...
                >
                  <div className="input-group d-flex flex-row">
                    <input
                      ...
                      onFocus={(event) => handelBlur_handleFocus(event, "")}
                      onBlur={(event) =>
                        handelBlur_handleFocus(event, "Email Address")
                      }
                      required=""
                      type="email"
                    />
        ...
        <div className="row footer-bottom d-flex justify-content-between align-items-center">
          <p className="col-lg-8 col-sm-12 footer-text m-0">
            ...
            <i className="fa fa-heart-o" aria-hidden="true"></i> by Ewoma Zino
            {/* <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> */}
          </p>
